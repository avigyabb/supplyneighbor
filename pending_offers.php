...
<?php
  ...
  if ($queryResult>0){
    while ($row = mysqli_fetch_assoc($results)){
      echo "<div class= 'requests-box'>
                ...
                <a href='pending_offers.php?request_id=".$row['request_id']."&hello=true'>Remove</a>
    ...
    echo "<h3>You have not made any offers yet! Click <a href='offer.php'>HERE</a> to make an offer.</h3>";
  }
  ...
  if (isset($_GET['hello'])) {
    ...
    $data = array(
              ...
              {
               $message = "<label>you Completed this Offer</label>";
              }
  }
