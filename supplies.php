...
<?PHP
if (isset($_GET['hello'])) {
$sender = 'contact@supplyneighbor.com';
...
$message2 = "You accepted {$_GET['name']}'s request for {$_GET['specific_task']}. Wait for {$_GET['name']} to verify the drop-off location and time, or contact them at {$_GET['email']} for any inquiries. Thank you for using SupplyNeighbor.";
$headers = 'From:' . $sender;
