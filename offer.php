 ...
 if($statement->execute($check_data))
 {
  ...
  else
  {
   ...
   if($message == '')
   {
    ...
    {
     $message = "<h4>Offer Posted. Click <a href='supplies-offers.php'>HERE</a> to see other offers and requests in your area.</h4>";
    }
    else{
   echo "";
   }
...
<div class="taskbar">
    ...
    <div class="dropdown-content3">
      ...
      <div class='show_bg_2'>
        <h1>Offer a Task or Supplies<h1>
      </div>
  ...
  <option value="opel">Grocery List</option>
      ...
      <div class="form-group">
       <h3>Specific Supplies Offered</h3>
       <h2>Put the specific supplies that you are offering. Medecinal items, supplies, groceries, etc.</h2>
       <div class="hiddend" style="width: 86%; display: inline-block;"><input type="text" name="specific_task" class="form-control" placeholder="5 Surgical Masks or 8 Rolls of Toilet Paper"/></div><div class="but" style="display: inline-block;"><button type="button" onclick="myFunction()">Add New</button></div>
     ...
     <div class="form-group">
      ...
      <div class="form-group">
        <h1>Double check that all the information above is accurate. Once you press "Offer" your offer will be added to the forum.</h1>
        <div class="crea">
          <input type="submit" name="register" class="btn btn-info" value="Offer" />
      </div>
      </div>
     </form>
    </div>
